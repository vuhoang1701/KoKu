...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().tintColor = UIColor.colorWithHexString(hexString: "#558FA6")
        UINavigationBar.appearance().barTintColor = UIColor.colorWithHexString(hexString: "#558FA6")
        ...
        loginviewController  = mainStoryboardIpad.instantiateViewController(withIdentifier: "CustomLoginViewController") as? CustomLoginViewController
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Koku")
    ...
    func logout()
    {
        UserSetting.sharedInstance.currentUser = nil
